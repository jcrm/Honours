...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"Shader/Texture/texture.vs", L"Shader/Texture/texture.ps");
	if(!result)
	{
		return false;
	}
...
bool TextureShaderClass::Render(ID3D11DeviceContext* device_context, int index_count_, D3DXMATRIX world_matrix, D3DXMATRIX viewMatrix, 
...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vs_filename, WCHAR* ps_filename)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vs_filename, NULL, NULL, "TextureVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, 
	...
	result = D3DX11CompileFromFile(ps_filename, NULL, NULL, "TexturePixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, 
...
bool TextureShaderClass::SetShaderParameters(ID3D11DeviceContext* device_context, D3DXMATRIX world_matrix, D3DXMATRIX viewMatrix, 
											 D3DXMATRIX projection_matrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
...
void TextureShaderClass::RenderShader(ID3D11DeviceContext* device_context, int index_count_)
{
