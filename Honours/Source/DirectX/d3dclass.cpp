...
bool D3DClass::InitDisplayMode(int screenWidth, int screenHeight, unsigned int &numerator, unsigned int &denominator){
	HRESULT result;
	IDXGIOutput* adapterOutput;
...
bool D3DClass::InitSwapChain(HWND hwnd, int screenWidth, int screenHeight, unsigned int& numerator, unsigned int& denominator, bool fullscreen){
	DXGI_SWAP_CHAIN_DESC swapChainDesc;
	HRESULT result;
...
bool D3DClass::InitDepthBuffer(int screenWidth, int screenHeight){
	HRESULT result;
	D3D11_TEXTURE2D_DESC depthBufferDesc;
