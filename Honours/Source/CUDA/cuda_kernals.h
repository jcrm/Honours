...
extern "C"
{
	...
	void cuda_fluid_advect_velocity(void*, void*, Size, float3, float3,  float3, float3);
	void cuda_fluid_advect_thermo(void*, void*, Size, float);
	void cuda_fluid_vorticity(void*, void*, Size);
	void cuda_fluid_force(void*, void*, Size);
	void cuda_fluid_bouyancy(void*, void*, void*, Size, Size);
	void cuda_fluid_thermo(void*, void*, Size);
